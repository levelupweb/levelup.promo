          ...
          <div className="container">
            ...
            <div className="jumbotron inverted">
              <div className="jumbotron-title">
                ...
                <br />
                <h3 className="super title">Levelup <span className="primary" style={{ fontWeight: "bold" }}>SMM</span></h3>
              </div>
        ...
        <section className="fullpage center seventh">
          <div className="container wide">
            ...
            <div className="section-actions inverted">
              <button className="button ghost" data-scrollTo=".ten">Начать работать вместе!</button>
            </div>
          </div>
        </section>
